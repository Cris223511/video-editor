...
export default function ManijaGiro({ onAgarrar }: { onAgarrar: (e: ReactPointerEvent) => void }) {
  return (
    <>
...
export function anguloGiro(cx: number, cy: number, ev: globalThis.PointerEvent): number {
